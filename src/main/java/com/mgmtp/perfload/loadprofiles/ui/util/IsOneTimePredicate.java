 ...
 * @author rnaegele
 */
public class IsOneTimePredicate implements Predicate<LoadProfileEntity> {
	@Override
	public boolean apply(final LoadProfileEntity input) {
		return input instanceof OneTime;
	}
}