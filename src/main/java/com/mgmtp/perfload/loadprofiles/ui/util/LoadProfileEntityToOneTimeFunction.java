 ...
 * @author rnaegele
 */
public class LoadProfileEntityToOneTimeFunction implements Function<LoadProfileEntity, OneTime> {
	@Override
	public OneTime apply(final LoadProfileEntity input) {
		return (OneTime) input;
	}
}