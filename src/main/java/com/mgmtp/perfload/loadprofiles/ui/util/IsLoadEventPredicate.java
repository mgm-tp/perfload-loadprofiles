 ...
 * @author rnaegele
 */
public class IsLoadEventPredicate implements Predicate<BaseLoadProfileEvent> {
	@Override
	public boolean apply(final BaseLoadProfileEvent input) {
		return input instanceof LoadEvent;
	}
}
